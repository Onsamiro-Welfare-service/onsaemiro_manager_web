...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-blue-600 text-slate-50 shadow-md hover:bg-blue-700",
        destructive:
        ...
        secondary:
          "bg-slate-100 text-slate-900 shadow-md hover:bg-slate-100/80",
        ghost:
...
const AchromaticButton = React.forwardRef<HTMLButtonElement, ButtonProps>(
...
AchromaticButton.displayName = "Button";

export default AchromaticButton;
