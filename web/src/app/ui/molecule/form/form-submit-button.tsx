...
import AchromaticButton, { buttonVariants } from '@/app/ui/atom/button/button';
...
export function FormSubmitButton({
  ...
  <div
    ...
    <AchromaticButton aria-label="submit-button" form={formId} size={size} variant={variant} type="submit" {...props}>
      {!pending ? (label):(<LoadingSpinner className="h-6 w-6 shrink-0 animate-spin" style={{ transition: `width 150ms` }}/>)}
    </AchromaticButton>
  </div>
  )
}
